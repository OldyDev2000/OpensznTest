...
@section('content')
    ...
    @foreach ($movies as $movie)
        <tr>
            ...
            <td><a href="{{ route('films.show', $movie->id) }}"><button class="btn btn-primary">Details</button></a></td>
            <td>
                <a href="{{ route('films.destroy', $movie->id) }}">
                <button class="btn btn-danger" onclick="return confirm('Etes vous sure de vouloir supprimer')">Supprimer</button></a>
            </td>
        </tr>
    @endforeach
